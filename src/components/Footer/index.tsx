...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 bg-white pt-16 dark:bg-gray-dark md:pt-20 lg:pt-24 pb-16 border-top">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 sm:w-12/12 md:w-1/2 lg:w-4/12 xl:w-4/12">
          ...
          <div className="h-px w-full from-transparent via-[#D2D8E183] to-transparent dark:via-[#959CB183] pb-6">

          <p className="text-left text-base text-body-color dark:text-white" style={{fontSize:"17px"}}>
            © 2023 AZUKI • All Rights Reserved
            </p>
          </div>
