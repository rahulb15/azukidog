...
const featuresData: Feature[] = [
  {
    id: 1,
    icon: (<Image src="/images/landing/dribbble.svg" alt="dribbble" width={40} height={40} />),
    title: "Azuki Buy Bot",
  ...
  },
  {
    id: 1,
    icon: (
      <Image src="/images/landing/file.svg" alt="figma" width={40} height={40} />
    ),
    ...
    },
  {
    id: 1,
    icon: (
      <Image src="/images/landing/tachometer.svg" alt="figma" width={40} height={40} />
